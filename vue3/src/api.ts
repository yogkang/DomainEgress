...
export interface Config {
  ...
  trend_retention_days: number; port_refresh_interval_seconds: number; font_scale: number;
...
export interface HostMapping { ip: string; domains: string[]; group: string }
export interface HostGroup { name: string; enabled: boolean; content: string }
...
], blacklist: [], http_host: '127.0.0.1', http_port: 19876, socks_host: '127.0.0.1', socks_port: 16789, auto_start: false, log_level: 'info', log_retention_days: 30, trend_retention_days: 21, port_refresh_interval_seconds: 30, font_scale: 100, whitelist_added_at: {}, blacklist_added_at: {}, ssh_profiles: [], active_ssh_profile: null, ssh_forwards: [], ssh_forward_options: [], icloud_sync_enabled: false, gist_provider: 'github', gist_id: '', gist_file_name: 'domain-egress-rules.json' }
