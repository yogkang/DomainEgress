...
export interface Config {
  ...
  ssh_profiles: SshProfile[]; active_ssh_profile: string | null; ssh_forwards: SshForwardRule[]; icloud_sync_enabled: boolean;
...
export interface SshForwardRule { id: string; name: string; project: string; note: string; local_port: number | null; remote_host: string; remote_port: number; bind_host: string; ssh_host: string; ssh_port: number; ssh_username: string; ssh_keychain_id?: string | null; auto_start: boolean }
...
], blacklist: [], http_host: '127.0.0.1', http_port: 19876, socks_host: '127.0.0.1', socks_port: 16789, auto_start: true, log_level: 'info', log_retention_days: 30, trend_retention_days: 21, whitelist_added_at: {}, blacklist_added_at: {}, ssh_profiles: [], active_ssh_profile: null, ssh_forwards: [], icloud_sync_enabled: false, gist_provider: 'github', gist_id: '', gist_file_name: 'domain-egress-rules.json' }
