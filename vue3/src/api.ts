...
], blacklist: [], http_host: '127.0.0.1', http_port: 19876, socks_host: '127.0.0.1', socks_port: 16789, auto_start: true, log_level: 'info', log_retention_days: 30, trend_retention_days: 21, whitelist_added_at: {}, blacklist_added_at: {}, ssh_profiles: [], active_ssh_profile: null, ssh_forwards: [], ssh_forward_options: [], icloud_sync_enabled: false, gist_provider: 'github', gist_id: '', gist_file_name: 'domain-egress-rules.json' }
