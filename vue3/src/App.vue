...
.forward-layout-actions { display:flex; justify-content:flex-end; margin:-4px 0 8px; }
.forward-layout-actions button { padding:6px 10px; font-size:12px; }
.forward-menu-collapsed .forward-split-layout { grid-template-columns:minmax(0,1fr); }
.forward-menu-collapsed .forward-group-menu { display:none; }
.grouped-forward-list { display:none; }
.forward-split-layout { display:grid; grid-template-columns:220px minmax(0,1fr); gap:12px; }
.forward-group-menu { padding:10px; border:1px solid var(--border); border-radius:10px; background:var(--surface-muted); align-self:start; }
