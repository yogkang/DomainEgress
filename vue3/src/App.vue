...
async function checkUpdate() { if (!desktop) return; updateBusy.value = true; try { updateInfo.value = await call<UpdateInfo>('check_update') } catch (e) { updateInfo.value = { current_version: '0.2.0', latest_version: null, release_url: null, available: false, error: String(e) } } finally { updateBusy.value = false } }
...
function addSshForward() { showSshCommandParser.value = true; sshCommand.value = ''; parsedForwardIds.value = [] }
